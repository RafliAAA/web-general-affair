    ...
    <DashboardLayout title="Dashboard">
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          ...
          {/* <StatCard
            label="Pengadaan"
            value={data.procurement.total}
            icon={ShoppingCart}
            colorClass="bg-green-100 text-green-600"
          />
          <StatCard
            label="Disposal"
            value={data.disposal.total}
            icon={Trash2}
            colorClass="bg-red-100 text-red-600"
          /> */}
          <StatCard
            label="Handover Aktif"
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            <div className="flex items-center gap-3 p-3 rounded-lg bg-slate-50 border border-slate-200">
              ...
              <div>
                ...
                <p className="text-lg font-semibold text-green-600">{data.assets.tersedia}</p>
              </div>
            </div>
            <div className="flex items-center gap-3 p-3 rounded-lg bg-slate-50 border border-slate-200">
            ...
            <div className="flex items-center gap-3 p-3 rounded-lg bg-slate-50 border border-slate-200">
              ...
              <div>
                <p className="text-xs text-violet-700">Peminjaman Menunggu</p>
                <p className="text-lg font-semibold text-violet-700">
                  {data.borrows.menunggu}
                </p>
              </div>
            </div>
          </div>
