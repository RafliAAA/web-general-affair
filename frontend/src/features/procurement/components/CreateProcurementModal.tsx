...
import { Plus, Trash2, ChevronsUpDown, Check, Eye } from "lucide-react";
...
const CreateProcurementModal = ({ onCreate }: Props) => {
  ...
  const [previewActual, setPreviewActual] = useState<any | null>(null);
  ...
  return (
    <>
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        >
          ...
          <div className="space-y-4 py-2">
            {/* COMBOBOX FORM AKTUALISASI + TOMBOL LIHAT DETAIL */}
            <div className="space-y-1.5">
              ...
              <div className="flex gap-2">
                ...
                {/* TOMBOL PREVIEW DENGAN UKURAN FIX SHINK-0 */}
                {selectedActualization && (
                  <Button
                    type="button"
                    variant="outline"
                    ...
                    onClick={() => setPreviewActual(selectedActualization)}
                    title="Lihat detail form aktualisasi"
                  >
      ...
      {/* MODAL PREVIEW DETAIL AKTUALISASI */}
      <Dialog
        open={!!previewActual}
        onOpenChange={() => setPreviewActual(null)}
      >
          ...
          {previewActual && (
            <div className="space-y-3 py-2 text-sm">
              <div className="flex justify-between border-b pb-2">
                <span className="text-muted-foreground">Nomor Form</span>
                <span className="font-medium">{previewActual.form_number}</span>
              </div>
              <div className="flex justify-between border-b pb-2">
                <span className="text-muted-foreground">Pelapor</span>
                <span className="font-medium">{previewActual.user_name}</span>
              </div>
              <div className="flex justify-between border-b pb-2">
                <span className="text-muted-foreground">Durasi</span>
                <span className="font-medium">
                  {previewActual.duration_minutes} Menit
                </span>
              </div>
              ...
              <div className="space-y-1 border-b pb-2">
                <span className="text-muted-foreground block">Handling:</span>
                <p className="bg-muted/50 p-2 rounded text-xs">
                  {previewActual.handling || "-"}
                </p>
              </div>
