...
const BorrowTable = ({
  ...
  // 🌟 CEK APAKAH TABEL INI DIPAKAI DI SECTION RIWAYAT
  const isHistorySection = borrows.every((b) =>
    ["Dikembalikan", "Ditolak", "Dibatalkan"].includes(b.status),
  );
      ...
      <Table className="min-w-full">
        <TableHeader>
          <TableRow>
            ...
            {/* 🌟 SEMBUNYIKAN KOLOM INI KALAU DI RIWAYAT */}
            {!isHistorySection && <TableHead>Tgl Diambil</TableHead>}
        ...
        <TableBody>
          {borrows.map((b) => (
            ...
            >
              ...
              {/* 🌟 SEMBUNYIKAN CELL INI KALAU DI RIWAYAT */}
              {!isHistorySection && (
                <TableCell
                  className="text-sm"
                ...
                >
                  {b.taken_date ? (
                    formatDate(b.taken_date)
                  ) : b.status === "Disetujui" && onMarkAsTaken ? (
                    <Button
                      size="sm"
                      variant="outline"
                      onClick={() => onMarkAsTaken(b.borrow_id)}
                    >
                      Tandai Diambil
                    </Button>
                  ) : (
