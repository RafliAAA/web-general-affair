...
const BorrowPage = () => {
  ...
  const handleConfirm = async ( borrow_reason: string, expected_return_date: string) => {
    if (!selectedAsset) return;
    try {
      setSubmitting(true);
      await handleBorrowRequest(selectedAsset.asset_id, borrow_reason, expected_return_date);
